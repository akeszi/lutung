...
This is a fork of the original Lutung repository, which can be found [here](https://github.com/rschreijer/lutung)

I wanted the use the broad functionality of the Lutung library, without importing the apache httpclient library, which is a dependency of the original Lutung library.
